...
class UpdateAnalisaPAPRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'visc_40' => 'nullable|numeric|between:0,9999.99',
    ...
    {
        $this->merge(array_map('strtoupper', $this->all())); // Mengubah semua input menjadi huruf besar
    }
}
