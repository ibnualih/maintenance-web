...
@section('title', 'Strainer Resume & Chart')

@section('main')
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Strainer Resume & Chart</h1>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('strainer.resume') }}" class="mb-3">
                        <div class="form-row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ route('strainer.resume') }}" class="btn btn-secondary">Reset</a>
                            </div>
                        </div>
                    </form>
                    <div class="table-responsive">
                        {{-- <h1 class="mb-4">Resume Strainers (Approved Only)</h1> --}}
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>HM</th>
                                    <th>ED
                                        <a href="{{ route('strainer.resume', array_merge(request()->all(), ['sort_ed' => 'asc'])) }}" class="btn btn-link p-0">
                                            <i class="fas fa-sort-amount-down"></i>
                                        </a>
                                        <a href="{{ route('strainer.resume', array_merge(request()->all(), ['sort_ed' => 'desc'])) }}" class="btn btn-link p-0">
                            ...
                            <tbody>
                                @forelse ($approvedData as $strainer)
                                    <tr>
